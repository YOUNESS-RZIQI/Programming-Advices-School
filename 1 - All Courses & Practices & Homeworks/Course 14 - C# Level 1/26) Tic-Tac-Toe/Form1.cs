...
namespace Tic_Tac_Toe
{
    public partial class frm_Main : Form
    {
        ...
        // Clicks
        private void pb_Box_0_0_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_0_1_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_0_2_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_1_0_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_1_1_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_1_2_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_2_0_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_2_1_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }

        private void pb_Box_2_2_Click(object sender, EventArgs e)
        {
            Game_Box_Changed((PictureBox)sender);
        }
