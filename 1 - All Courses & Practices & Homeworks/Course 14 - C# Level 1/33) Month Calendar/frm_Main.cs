...
namespace Practice
{
    public partial class frm_Main : Form
    {
        ...
        private void bt_Start_Date_Click(object sender, EventArgs e)
        {
            MessageBox.Show(mcl_m1.SelectionRange.Start.ToShortDateString());
        }

        private void bt_End_Date_Click(object sender, EventArgs e)
        {
            MessageBox.Show(mcl_m1.SelectionRange.End.ToShortDateString());
        }
    }
}
